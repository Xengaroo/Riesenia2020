...
public class TestSubtitles {
	...
	@Test
	public void testSubtitles() throws FileNotFoundException, UnsupportedEncodingException {
	...
	@Test
	public void testBonus() throws FileNotFoundException, UnsupportedEncodingException {
		List<List<String>> files = Arrays.asList(
